mviewer.customLayers.inventaire = (function () {
    ...
    var _elsLoader = function(extent, resolution, projection) {
        ...
        // Mots-clefs de l'outil filtrage définis ici
    ...
    var _handle = function(clusters, views) {
        ...
        var features = clusters[0].getProperties().features;
            var extraTemplate = [
                ...
                '{{#lien_dossier}}',
                '<div class="but_link">',
                '<p> <a href="{{lien_dossier}}" target=_blank"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> Fiche du géosite</a>',
                '</p>',
                '</div>',
                '{{/lien_dossier}}',
                '{{#url}}',
