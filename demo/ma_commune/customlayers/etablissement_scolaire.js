...
const COULEUR_POINT = "#cf7a26"; //Couleur du point cluster
const LABEL_LEGEND = "Etablissement scolaire";
const REQ_CQL = "&CQL_FILTER=code_commune=";
const code_insee = API.commune ?? undefined;

mviewer.customLayers.etablissement_scolaire = (function () { //Mettre le nom de la couche dans le XML
...
const _legend = {
  items: [
    { styles: manyStyle(10, 10, 7), label: LABEL_LEGEND, geometry: "Point" },
  ],
};
