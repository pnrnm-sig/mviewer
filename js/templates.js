...
mviewer.templates.layerControl = [
    '<li class="{{cls}}" data-layerid="{{layerid}}" data-title=" {{title}}">',
        ...
        '</div>',
        '<div class="mv-detailed-legend" style="display: initial;" data-layerid="{{layerid}}" >',
                '<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#detailed-legend-modal" data-backdrop="true">Légende détaillée</button>',
            '</div>',
        '<div class="mv-layer-options" style="display: initial;" data-layerid="{{layerid}}" >',
            '<div class="row">',
                '<div class="col-md-12">',
